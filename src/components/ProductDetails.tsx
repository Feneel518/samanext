...
const ProductDetails: FC<ProductDetailsProps> = ({ product }) => {
  return (
    ...
    //       <div className="flex flex-col gap-6  w-full pr-8 border-r h-full sticky top-32 ">
    //         <div className="">
    ...
    <section className="px-8">
      <div className="py-20 flex flex-col lg:flex-row gap-10 border-b border-gray-200/20">
        <div className="lg:w-[400px] lg:border-r border-gray-200/20 flex items-start lg:shrink-0 ">
          <div className="flex flex-col gap-6 lg:sticky lg:top-32 transition-all duration-200 ease-in-out w-full pr-8">
            <div className="">
              <Heading className="lg:text-5xl lg:w-[80%]">
                <h1>{product.name}</h1>
              </Heading>
            ...
            <div className="relative w-full h-[400px] ">
              <div
                className={cn(
                  "absolute inset-0 p-4 z-10 text-black font-oswald text-5xl flex flex-col gap-4",
                  {
