...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-24  items-center justify-center rounded-full border-2  text-black bg-white p-3 shadow-[0_0_20px_inset] shadow-blue-200",
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-lg max-h-[400px] items-stretch justify-between gap-10 mt-8">
        <div className="flex flex-row items-center justify-between font-syne">
          ...
          <Circle ref={div5Ref}>TV</Circle>
        </div>
        <div className="flex flex-row items-center justify-between  ">
          <Circle ref={div2Ref} className="relative">
            <Image
              alt="Fridge Line Diagram"
              src={"/FridgeLine.png"}
              fill
              className="object-contain"
            ></Image>
          ...
          <Circle ref={div4Ref} className="size-32 text-black">
            SAMA
          </Circle>
          <Circle ref={div6Ref}>Lift</Circle>
        </div>
        <div className="flex flex-row items-center justify-between ">
          <Circle ref={div3Ref} className="relative">
            <Image
              alt="Fridge Line Diagram"
              src={"/MicrowaveLine.png"}
              fill
              className="object-contain"
            ></Image>
          </Circle>
          <Circle ref={div7Ref}>Fan</Circle>
        </div>
      </div>
